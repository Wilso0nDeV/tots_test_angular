...
export class RegisterComponent implements OnInit {
  ...
  onClickOpenModal() {
    ...
    config.fields = [
      ...
      { key: 'firstaname', component: StringFieldComponent, label: 'Nombre', validators: [Validators.required] },
      { key: 'lastname', component: StringFieldComponent, label: 'Apellidos', validators: [Validators.required] },
      { key: 'email', component: StringFieldComponent, label: 'Email', validators: [Validators.required, Validators.email] },
      { key: 'submit', component: SubmitButtonFieldComponent, label: 'Enviar' }
    ];
